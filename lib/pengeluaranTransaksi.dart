...
class pengeluaranTransaksi extends StatefulWidget {
  final String username;

  pengeluaranTransaksi({required this.username});

  @override
  pengeluaranTransaksiState createState() => pengeluaranTransaksiState();
}

class pengeluaranTransaksiState extends State<pengeluaranTransaksi> {
