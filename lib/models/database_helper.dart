...
// Tambahkan kolom baru ke dalam tabel users
  ...
  Future<void> saveTransaction(
      String username, String transactionDate, double amount, String description, String transactionType) async {
    final dbClient = await db;
  ...
  Future<List<Map<String, dynamic>>> getTransactionsByDate(String username, String startDate, String endDate) async {
  final dbClient = await db;
  return await dbClient.query('transactions',
      where: 'username = ? AND transaction_date >= ? AND transaction_date <= ?',
